...
//public class Tour extends DSTour {
//    // region Thông tin bảng dữ liệu
//    private static final String TABLE_NAME = "tour";
//    private static final String COLUMN_ID = "tour_id";
//    private static final String COLUMN_TITLE = "tour_title";
...
//    private static final String COLUMN_MODIFIED_BY = "tour_modified_by";
//
////    public Tour(String createdBy, String modifiedBy, Date createdDate, Date modifiedDate, int id, double price, String title, byte[] image) {
////        super(createdBy, modifiedBy, createdDate, modifiedDate, id, price, title, image);
////    }
//
////    public Tour(int anInt, String string, String cursorString, byte[] blob) {
////        super(anInt, string, cursorString, blob);
////    }
//
//
//    // endregion
